                        ...
                        <table class="table table-bordered m-0">
                            ...
                            <tbody>
                                  ...
                                  <c:forEach var="item" items="${data}" varStatus="loop">
                                      <c:set var="total" value="${total + item.price*item.stockQuantity}" />
                                      <tr>
                                          <td class="p-4">
                                              <div class="media align-items-center">
                                                  <div class="media-body">
                                                      <h6 class="d-block text-dark" style="font-size: 18px;">${item.bookName}</h6>
                                                      <small>
                                          ...
                                          <input type="hidden" name="bookId" value="${item.bookId}"></input>
                                          <td class="align-middle p-4"><input type="number" min="1" max="20" class="form-control text-center" name="quantity" value="${item.stockQuantity}"></td>
                                          <td class="text-right font-weight-semibold align-middle p-4">${item.price * item.stockQuantity}</td>
                                          <td class="text-center align-middle px-0" >
                                              <button type="button" onclick="confirmDelete('${item.bookId}');" style="border: 0px; padding: 0px; background-color: white; " id="" class="" >
